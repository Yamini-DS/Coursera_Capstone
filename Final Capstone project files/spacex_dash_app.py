...
def build_scatter(site_dropdown,slider_range):
    ...
    if site_dropdown == 'ALL':
        ...
        fig = px.scatter(filtered_df,x="Payload Mass (kg)", y="class", color="Booster Version Category", title= "Success Launches for site {site_dropdown}".format(site_dropdown=site_dropdown))
    else:
        filtered_df1= filtered_df[filtered_df['Launch Site'] == site_dropdown]
        fig = px.scatter(filtered_df1, x="Payload Mass (kg)", y="class",color="Booster Version Category", title="Success Launches for site {site_dropdown}".format(site_dropdown=site_dropdown))   
    return fig
